...
{   
    ...
    {
        $target_dir = $_SERVER['DOCUMENT_ROOT'] . "/firphire/uploadbooks/";
        ...
        if (move_uploaded_file($_FILES["uploaded_file"]["tmp_name"], $target_file)) {
            $connect = mysqli_connect('localhost','root','','firphire');
            print_r($title);echo "   ";
            print_r($target_dir);echo "  ";
            print_r($target_file);echo "  ";
            print_r( $description );echo "  ";
            if($connect){
                $query = "INSERT INTO bookscontent(userid,booktitle,description,path) VALUES('$userid','$title','$description','$target_file')";
